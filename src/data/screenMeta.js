...
export const screens = [
  ...
  createScreen('parent.dashboard.single-child', '/parent/dashboard-single-child/0', 'Дом / Один ребенок (Миша)', 'Родитель', 'Dashboard'),
  createScreen('parent.dashboard.online', '/parent/dashboard-online', 'Дом / Несколько детей', 'Родитель', 'Dashboard'),
  ...
  createScreen('parent.tasks.no-child', '/parent/tasks-no-child', 'Задания / Нет ребенка', 'Родитель', 'Tasks'),
  createScreen('parent.tasks.single-child', '/parent/tasks-single-child', 'Задания / Один ребенок', 'Родитель', 'Tasks'),
  createScreen('parent.tasks.multi', '/parent/tasks-multi', 'Задания / Несколько детей', 'Родитель', 'Tasks'),
  createScreen('parent.schedule.default', '/parent/schedule', 'Расписание', 'Родитель', 'Tasks'),
  createScreen('parent.tasks.create', '/parent/tasks-create', 'Создание задачи / Один ребенок', 'Родитель', 'Tasks'),
  createScreen('parent.tasks.create-multi', '/parent/tasks-create-multi', 'Создание задачи / Несколько детей', 'Родитель', 'Tasks'),
  createScreen('parent.tasks.edit', '/parent/tasks-edit', 'Редактирование задачи', 'Родитель', 'Tasks'),
  createScreen('parent.tasks.delete-confirm', '/parent/tasks-delete-confirm', 'Подтверждение удаления', 'Родитель', 'Tasks'),
  ...
  createScreen('parent.apps.list', '/parent/apps-list', 'Контент / Список приложений', 'Родитель', 'Content'),
  createScreen('parent.apps.list.search', '/parent/apps-list-search', 'Контент / Поиск по названию', 'Родитель', 'Content'),
  createScreen('parent.apps.list.status-allowed', '/parent/apps-list-allowed', 'Контент / Статус: Разрешенные', 'Родитель', 'Content'),
  createScreen('parent.apps.list.status-limited', '/parent/apps-list-limited', 'Контент / Статус: Ограниченные', 'Родитель', 'Content'),
  createScreen('parent.apps.list.status-blocked', '/parent/apps-list-blocked', 'Контент / Статус: Заблокированные', 'Родитель', 'Content'),
  createScreen('parent.apps.list.new', '/parent/apps-list-new', 'Контент / Новые приложения', 'Родитель', 'Content'),
  createScreen('parent.apps.settings.limited', '/parent/app-settings-limited', 'Контент / Приложение: Ограничено', 'Родитель', 'Content'),
  createScreen('parent.apps.settings.blocked', '/parent/app-settings-blocked', 'Контент / Приложение: Заблокировано', 'Родитель', 'Content'),
  createScreen('parent.apps.settings.general', '/parent/apps-settings', 'Контент / Настройка приложений', 'Родитель', 'Content'),
  createScreen('parent.content.filter.default', '/parent/content-filter', 'Контент / Настройка контента', 'Родитель', 'Content'),
  createScreen('parent.content.sites', '/parent/content-sites', 'Контент / Списки сайтов', 'Родитель', 'Content'),
  createScreen('parent.content.purchases', '/parent/content-purchases', 'Контент / Покупки', 'Родитель', 'Content'),
