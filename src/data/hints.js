...
export const hints = {
  ...
  'parent.add-child.intro': makeHint('Поведение', [
    'Заполните имя (обязательно), возраст, пол и класс — опционально.',
    'После нажатия "Добавить ребенка" появится код для ввода в приложении ребенка.',
  ]),
  ...
  'parent.tasks.no-child': makeHint('Поведение', [
    'Экран показывается, когда нет привязанных детей.',
    'Кнопка ведет к добавлению ребенка.',
  ]),
  'parent.tasks.single-child': makeHint('Поведение', [
    'Список задач для одного ребенка.',
    'Кнопка ведет к созданию задачи. Ссылка — в календарь.',
  ]),
  'parent.tasks.multi': makeHint('Поведение', [
    'Переключатель фильтрует задачи по ребенку, не переходит в профиль.',
  ]),
  ...
  'parent.apps.list': makeHint('Иерархия и навигация', [
    'Хлебные крошки показывают: Контент > Контроль приложений.',
    'Ребенок: Миша | Аня | Лева — переключение ведет на дашборд выбранного ребенка.',
    'Список приложений относится к выбранному ребенку (по умолчанию Миша).',
    'Откройте YouTube, чтобы перейти в карточку приложения.',
  ]),
  'parent.apps.settings.limited': makeHint('Иерархия и навигация', [
    'Кнопка «Назад к списку приложений» возвращает в список.',
    'Хлебные крошки: Контент > Контроль приложений > YouTube.',
  ]),
  'parent.apps.settings.blocked': makeHint('Иерархия и навигация', [
    'Кнопка «Назад к списку приложений» возвращает в список.',
    'Хлебные крошки: Контент > Контроль приложений > TikTok.',
  ]),
  'parent.apps.list.search': makeHint('Иерархия и навигация', [
    'Экран с примененным поиском. Кнопка «Назад» ведет в основной список приложений.',
  ]),
  'parent.apps.list.status-allowed': makeHint('Иерархия и навигация', [
    'Фильтр «Разрешенные» применен. Показаны приложения для Миши.',
    'Кнопка «Назад к списку приложений» возвращает в полный список.',
  ]),
  'parent.apps.list.status-limited': makeHint('Иерархия и навигация', [
    'Фильтр «Ограниченные» применен. Кнопка «Назад» ведет в список.',
  ]),
  'parent.apps.list.status-blocked': makeHint('Иерархия и навигация', [
    'Фильтр «Заблокированные» применен. Кнопка «Назад» ведет в список.',
  ]),
  'parent.apps.list.new': makeHint('Иерархия и навигация', [
    'Новые приложения подсвечены. Кнопка «Назад» ведет в список.',
  ]),
  'parent.apps.settings.general': makeHint('Иерархия и навигация', [
    'Общие настройки приложений. Кнопка «Назад» ведет в список приложений.',
  ]),
  'parent.content.filter.default': makeHint('Иерархия и навигация', [
    'Контент > Настройка контента. Блокировка контента, уровень защиты, списки сайтов, покупки.',
    'Кнопка «Назад» ведет в список приложений.',
    'Ребенок: переключение ведет на дашборд выбранного ребенка.',
  ]),
  'parent.content.sites': makeHint('Иерархия и навигация', [
    'Контент > Настройка контента > Списки сайтов. Кнопка «Назад» ведет в настройку контента.',
  ]),
  'parent.content.purchases': makeHint('Иерархия и навигация', [
    'Контент > Настройка контента > Покупки. Кнопка «Назад» ведет в настройку контента.',
  ]),
  ...
  'child.friends.default': makeHint('Поведение', [
    'Экран демонстрирует друзей, чат и сравнение монет.',
  ]),
