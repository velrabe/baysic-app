...
export default function TaskListMulti() {
  ...
  return (
    <PhoneFrame bottomNav={parentTabs} fab={<Link to="/parent/tasks-create-multi" className={styles.fab} aria-label="Создать задачу">+</Link>}>
